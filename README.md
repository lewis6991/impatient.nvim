...
* Adds a chunk cache for `loadfile()`
* Adds a module resolution cache for `nvim__get_runtime()`
...
[fix(lua): restore priority of the preloader](https://github.com/neovim/neovim/pull/17302)
